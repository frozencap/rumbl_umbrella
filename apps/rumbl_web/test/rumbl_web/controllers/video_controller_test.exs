defmodule RumblWeb.VideoControllerTest do
  ...
  test "authorizes actions against access by other users", %{conn: conn} do
    ...
    # there is a protocol between Plug and Ecto where Plug is told to treat all Ecto.NoResultsError as a 404 response status, which we can also refer to as :not_found
